...
import { ArrowRight, Brain, Heart, Mic2, MapPin, Gift, Zap, ShieldCheck } from "lucide-react";
      ...
      <main>
        ...
        >
          ...
          <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 -top-32 md:-top-48 z-20">
              <div className="w-40 h-40 md:w-56 md:h-56 mx-auto rounded-full shadow-2xl overflow-hidden border-4 border-white ring-8 ring-dyad-dark/5 transition-transform hover:scale-105 duration-700">
                <img 
        ...
        <section className="bg-dyad-dark py-24 md:py-32 text-white">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="relative bg-white border-none p-8 transition-all hover:scale-[1.02] shadow-2xl group overflow-hidden cursor-default">
        ...
        <section className="bg-white py-24 md:py-32">
          <div className="container mx-auto px-6 max-w-4xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2 bg-dyad-background-soft rounded-3xl p-8 border border-dyad-soft/30 flex items-center justify-center aspect-square md:aspect-auto md:h-full group">
        ...
        <section className="bg-white py-24">
          <div className="container mx-auto px-6 max-w-2xl text-center">
            <div className="bg-dyad-background-soft p-8 md:p-12 rounded-3xl shadow-lg border border-dyad-soft/30">
