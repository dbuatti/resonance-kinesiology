    ...
    <div className="bg-dyad-background-soft min-h-screen text-slate-900">
      ...
      <section className="py-0">
        <div className="space-y-0">
          ...
          {/* Option 1 - Dark Background: Text must be pure white or very light */}
          <div className="bg-dyad-dark text-white">
            <div className="container mx-auto px-6 max-w-6xl py-16">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <span className="inline-block px-3 py-1 rounded bg-white/10 text-white/90 text-sm font-bold uppercase tracking-widest mb-6">Option 1</span>
                  <h3 className="text-4xl font-serif mb-6 text-white">Full Fee — Kinesiology & Energy Balancing</h3>
                  <p className="text-2xl font-bold mb-8 text-dyad-accent-light">$100 · 90 minutes</p>
                  ...
                  <a href="/schedule?type=full-fee">
                    <Button size="lg" className="bg-white text-dyad-dark hover:bg-dyad-background-soft font-bold shadow-lg h-14 px-8">
          ...
          <div className="bg-white border-y border-dyad-soft/30">
            <div className="container mx-auto px-6 max-w-6xl py-16">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <span className="inline-block px-3 py-1 rounded bg-dyad-soft text-dyad-accent text-sm font-bold uppercase tracking-widest mb-6">Option 3</span>
                  <h3 className="text-4xl font-serif text-dyad-dark mb-6">Community — Free Access (Limited)</h3>
                  <p className="text-2xl font-bold text-dyad-accent mb-8">Free · 90 minutes</p>
                  ...
                  <a href="/schedule?type=free-access">
                    <Button size="lg" className="bg-dyad-accent hover:bg-dyad-dark text-white font-bold shadow-lg h-14 px-8">
